...
1. **"The authority chair should explain everything carefully so the document is complete."** Its bias toward assuming too much is deliberate and it is told not to compensate. A chair that preempts its own assumptions returns an empty ledger and teaches nobody anything.
