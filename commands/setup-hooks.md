---
description: Install opt-in documentation hooks (git pre-commit lint, in-session doc lint). Default off, nothing is installed without your choice
argument-hint: [pre-commit | claude-code | all]
---
